...
# Importance: 3=high (essentials), 2=medium, 1=low (luxury)
PRODUCT_CATEGORIES = {
    "Food & Groceries": 3,
    "Fresh Produce": 3,
...
PRODUCT_CATALOG = [
    ...
    Item("Protein Shake", 4.0, 8.0, "Food & Groceries"),
    ...
    # Home Decor
    Item("Picture Frame", 12.0, 24.0, "Luxury"),
    Item("Wall Art", 25.0, 50.0, "Luxury"),
    Item("Throw Pillow", 15.0, 30.0, "Luxury"),
    Item("Blanket", 25.0, 50.0, "Household Essentials"),
    Item("Curtains", 30.0, 60.0, "Luxury"),
    Item("Area Rug", 60.0, 120.0, "Luxury"),
    Item("Table Lamp", 35.0, 70.0, "Luxury"),
    Item("Floor Lamp", 50.0, 100.0, "Luxury"),
    Item("Wall Clock", 20.0, 40.0, "Luxury"),
    Item("Vase", 18.0, 36.0, "Luxury"),
    Item("Candle Holder", 12.0, 24.0, "Luxury"),
    Item("Plant Pot", 10.0, 20.0, "Luxury"),
    Item("Fake Plant", 15.0, 30.0, "Luxury"),
    Item("Mirror", 40.0, 80.0, "Luxury"),
