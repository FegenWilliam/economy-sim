...
def run_day(game_state: GameState, show_details: bool = True) -> Dict[str, float]:
    ...
    3. Execute buy orders for the player
    ...
    9. Apply daily price fluctuations for next day (at END of day)

    Returns dictionary of daily sales.
    """
...
SAVE_FILE = "economy_sim_save_singleplayer.json"
...
def run_game() -> None:
    ...
    print("=" * 60)
    print("\nIn this game, you run a store competing for customers.")
